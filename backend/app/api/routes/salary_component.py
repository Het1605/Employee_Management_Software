...
def get_component(
    ...
    return SalaryStructureService.get_salary_component_by_id(db, component_id)
...
def update_component(
    ...
    return SalaryStructureService.update_salary_component(db, component_id, data)
...
def delete_component(
    ...
    return SalaryStructureService.delete_salary_component(db, component_id)
