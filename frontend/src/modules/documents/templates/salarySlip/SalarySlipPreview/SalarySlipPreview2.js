    ...
    <div className={styles.previewColumn}>
      <div className={styles.a4PreviewLandscape}>
        ...
        <div className={styles.salaryPreviewBody}>
          <div className={styles.salaryTitle} style={{ textAlign: 'center', marginBottom: '20px', fontSize: '18px', fontWeight: 'bold' }}>
            SALARY SUMMARY (YEARLY)
          </div>

          <div className={styles.salaryInfoSection} style={{ marginBottom: '20px', borderBottom: 'none' }}>
              <table className={styles.salaryInfoTable}>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className={styles.salaryInfoCell}></td>
                    </tr>
                    ...
                    <tr>
                        <td className={styles.salaryInfoCell}><strong>Total Leaves:</strong> {fDays(leaves)}</td>
                        <td className={styles.salaryInfoCell}></td>
                    </tr>
                </tbody>
              </table>
          ...
          <table className={styles.salaryLedgerTable}>
              <thead>
                  <tr className={styles.salaryLedgerHeader}>
                      ...
                      {compNames.map(c => <th key={c} style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right' }}>{c}</th>)}
                      <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right' }}>Leave Deduction</th>
                  </tr>
              </thead>
              <tbody>
