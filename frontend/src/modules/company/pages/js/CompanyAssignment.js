...
import styles from '../styles/CompanyAssignment.module.css';
...
const CompanyAssignment = () => {
    ...
    const handleAssign = async () => {
        ...
        try {
            await assignUsersToCompany(selectedCompanyId, selectedAvailable);
    ...
    const handleUnassign = async () => {
        ...
        try {
            await unassignUsersFromCompany(selectedCompanyId, selectedAssigned);
    ...
    const handleSingleAssign = async (userId) => {
        try {
            await assignUsersToCompany(selectedCompanyId, [userId]);
    ...
    const handleSingleUnassign = async (userId) => {
        try {
            await unassignUsersFromCompany(selectedCompanyId, [userId]);
